...
export function BookSummaryList({ items, locale }: Props) {
  return (
    <div className="overflow-x-auto -mx-4 px-4">
      <div className="flex gap-4 pb-4">
        {items.map((item) => (
          <BookSummaryDrawer key={item.id} bookSummary={item} locale={locale}>
            <div
              className={cn(
...
// function BookRecommendationItem({ item }: { item: BookSummary }) {
//   return (
//     <div
//       className={cn(
